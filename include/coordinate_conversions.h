...
void Rne_from_lla(const double lla[3], // lat, lon, alt above ellipsoid [rad, rad, m]
                  double Rne[3][3]);   // rotation matrix
...
void rot_mult(const double R[3][3], const double vec[3], double vec_out[3], bool transpose);
